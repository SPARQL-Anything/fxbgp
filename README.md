...
The traces of the experiments reported in the paper for the research questions RQ1 and RQ2 are contained in `execution_traces.zip`. More about the execution traces in  README file of  the archive. 

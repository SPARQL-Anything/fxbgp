...
public class CSVStreamingTest extends FXStreamExecutorTest{
    ...
    @Test
    public void c1_csv_c1() throws IOException {
        prepare(testName.getMethodName());
        testSelectStarEquals(new CSVTriplifier(), properties());
    }
    ...
    @Test
    public void f100_csv_fVVLVVL() throws IOException {
        prepare(testName.getMethodName());
        testSelectStarEquals(new CSVTriplifier(), properties());
    }

    @Test
    public void f1_csv_V31a2() throws IOException {
        prepare(testName.getMethodName());
        testSelectStarEquals(new CSVTriplifier(), properties());
    }

    @Test
    public void f1_csv_T2V41() throws IOException {
        prepare(testName.getMethodName());
        testSelectStarEquals(new CSVTriplifier(), properties());
    }
    ...
    @Test
    public void f10_csv_T2V41() throws IOException {
        prepare(testName.getMethodName());
        testSelectStarEquals(new CSVTriplifier(), properties());
    }

    @Test
    public void f100_csv_T2V41() throws IOException {
        prepare(testName.getMethodName());
        testSelectStarEquals(new CSVTriplifier(), properties());
    }
}

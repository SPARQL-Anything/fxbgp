    ...
    public void triplify(Properties properties, TriplifierEventsHandler handler) throws IOException, TriplifierHTTPException {
        ...
        try (InputStream is = Triplifier.getInputStream(properties); Reader in = new InputStreamReader(BOMInputStream.builder().setInputStream(is).get(), charset)) {
            ...
            while (recordIterator.hasNext()) {
                ...
                processRow(rown, dataSourceId, SPARQLAnythingConstants.ROOT_ID, record, headers_map, handler, ignoreColumnsWithNoHeaders);
            }

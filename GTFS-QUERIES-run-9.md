...
| ---- | ------------ | ----------------- | ---- | ---- | -- | ------ |
| c1-csv-strategy1-no_slice.sparql | 1 | 1 | 10 | 10 | 16 | 512 |
| c1-csv-strategy1-no_slice.sparql | 2 | 1 | 10 | 9 | 1 | 512 |
| c1-csv-strategy1-no_slice.sparql | 3 | 1 | 10 | 9 | 0 | 512 |
...
| c1-csv-strategy1-no_slice.sparql | 10 | 1 | 6 | 5 | 0 | 32 |
...
| q12-csv-strategy1-no_slice.sparql | 1 | 1 | 3 | 2 | 1 | 4 |
...
| q18-csv-strategy1-no_slice.sparql | 1 | 1 | 2 | 2 | 1 | 4 |
...
| q2-csv-strategy1-no_slice.sparql | 1 | 1 | 2 | 1 | 1 | 2 |
...
| q3-csv-strategy1-no_slice.sparql | 1 | 1 | 2 | 1 | 1 | 2 |
...
| q4-csv-strategy1-no_slice.sparql | 1 | 1 | 2 | 1 | 1 | 2 |
| q4-csv-strategy1-no_slice.sparql | 2 | 1 | 2 | 1 | 1 | 2 |
...
| q7-csv-strategy1-no_slice.sparql | 3 | 1 | 2 | 1 | 1 | 2 |
...
| q8-csv-strategy1-no_slice.sparql | 4 | 1 | 3 | 2 | 1 | 4 |
...
| q9-csv-strategy1-no_slice.sparql | 1 | 1 | 5 | 4 | 1 | 16 |
...
| name | bgpx | found | varSize | size | ms | tested |
| ---- | ------------ | ----------------- | ---- | ---- | -- | ------ |
| c1-csv-strategy1-no_slice.sparql | 1 | 512 | 10 | 10 | 86 | 512 |
| c1-csv-strategy1-no_slice.sparql | 2 | 512 | 10 | 9 | 57 | 512 |
| c1-csv-strategy1-no_slice.sparql | 3 | 512 | 10 | 9 | 45 | 512 |
| c1-csv-strategy1-no_slice.sparql | 4 | 128 | 8 | 7 | 9 | 128 |
| c1-csv-strategy1-no_slice.sparql | 5 | 4096 | 13 | 12 | 566 | 4096 |
| c1-csv-strategy1-no_slice.sparql | 6 | 1024 | 11 | 10 | 64 | 1024 |
| c1-csv-strategy1-no_slice.sparql | 7 | 8 | 4 | 3 | 0 | 8 |
| c1-csv-strategy1-no_slice.sparql | 8 | 64 | 7 | 6 | 2 | 64 |
| c1-csv-strategy1-no_slice.sparql | 9 | 32 | 6 | 5 | 0 | 32 |
| c1-csv-strategy1-no_slice.sparql | 10 | 32 | 6 | 5 | 0 | 32 |
...
| q12-csv-strategy1-no_slice.sparql | 3 | 4 | 3 | 2 | 1 | 4 |
...
| q18-csv-strategy1-no_slice.sparql | 5 | 2 | 2 | 1 | 1 | 2 |
...
| q4-csv-strategy1-no_slice.sparql | 4 | 2 | 2 | 1 | 1 | 2 |
| q4-csv-strategy1-no_slice.sparql | 5 | 2 | 2 | 1 | 0 | 2 |
| q4-csv-strategy1-no_slice.sparql | 6 | 8 | 4 | 3 | 1 | 8 |
...
| q7-csv-strategy1-no_slice.sparql | 7 | 4 | 3 | 2 | 1 | 4 |
...
| q8-csv-strategy1-no_slice.sparql | 9 | 2 | 2 | 1 | 1 | 2 |
| q8-csv-strategy1-no_slice.sparql | 10 | 2 | 2 | 1 | 0 | 2 |
| q8-csv-strategy1-no_slice.sparql | 11 | 4 | 3 | 2 | 1 | 4 |
| q9-csv-strategy1-no_slice.sparql | 1 | 16 | 5 | 4 | 1 | 16 |
| q9-csv-strategy1-no_slice.sparql | 2 | 2 | 2 | 1 | 0 | 2 |
| q9-csv-strategy1-no_slice.sparql | 3 | 8 | 4 | 3 | 0 | 8 |
